...
import time
import calendar
from controller.utils import snowFlow,OperationMysql
...
# todo mask项目的插入新冠的collection
def insertXingGuanCollection(human_face):
    img1_representation = changeImgToMilvus.changeImgToMilvus(human_face)
